...
const variantMap = {
  ...
  error: 'h-px bg-gradient-to-r from-transparent via-error/40 to-transparent',
  'error-strong': 'h-px bg-gradient-to-r from-transparent via-error/50 to-transparent',
} as const
