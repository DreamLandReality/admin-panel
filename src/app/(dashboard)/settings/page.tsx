export default function SettingsPage() {
    return (
        <div className="flex flex-col items-center justify-center min-h-[80vh] w-full animate-fade-in">
            ...
            <h1 className="font-serif text-3xl text-foreground mb-2 tracking-wide">System Settings</h1>
            <p className="text-[13px] font-medium uppercase tracking-[0.2em] text-foreground-muted">Configuration Coming Soon</p>
        </div>
    )
}
